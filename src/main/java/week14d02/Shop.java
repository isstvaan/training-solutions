...
public class Shop {
    ...
    public static final String SEPARATOR_TRANSACTION = ":";
    public static final String SEPARATOR_CUSTOMER = "-";
    ...
    private void procLine(String line) {
        String[] strings = line.split(SEPARATOR_TRANSACTION);
        String[] custStrings = strings[0].split(SEPARATOR_CUSTOMER);
        String[] itemStrings = strings[1].trim().split(SEPARATOR_ITEM);
